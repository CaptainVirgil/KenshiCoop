...
Replicator::Replicator()
    : catchupK_(CATCHUP_K), snapDist_(SNAP_DIST), snapSeconds_(SNAP_SECONDS),
      ...
      freezeSkipDriven_(0), freezeSkipCombat_(0), weatherSync_(true), dialogueSync_(true), weatherLastSendMs_(0),
      ...
      censusPubTrunc_(false), censusTrunc_(false), censusTruncLogMs_(0),
      wideTruncPrev_(false), censusFreshPrev_(false), censusRejudge_(false),
      wideSweepMs_(0),
      censusFreshChkMs_(0),
      ...
      doorSeqOut_(1), doorSampleMs_(0),
      doorSent_(0), doorResent_(0), doorRecv_(0),
      doorNoHand_(0), doorConverged_(0), doorApplied_(0), doorRollupMs_(0),
      doorSync_(true),
